...
const ProfileModal = () => {
    ...
    return (
        <div className='w-45 border-2 rounded-2xl p-2 bg-green-100 border-green-100 shadow shadow-green-300'>
            <div>
                <Link to="/profile" className="p-1 rounded-4xl flex justify-between items-center hover:bg-green-200">
                    <h2 to="/profile" className='text-[14px] font-semibold'>Profile</h2>
                    <CgProfile />
                </Link>
            </div>
